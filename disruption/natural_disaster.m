function towers_table = natural_disaster(center, radius, destruction_probability, damage_probability, towers_table)
...
%                               disaster
%   radius                    : the radius of the disaster expressed in
%                               meters
...
towers_affected = distances <= radius;
